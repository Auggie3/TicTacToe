...
public class Test {
    public static void main(String[] args) {
        ...
        HumanPlayer p1 = new HumanPlayer("Gio",'c');
        ...
        ComputerExpertPlayer expert = new ComputerExpertPlayer("SmartCOM", 'd');
        //TicTacToe<Player,Player> game = new TicTacToe<Player,Player>(new ComputerExpertPlayer("SmarterCom",'x'),expert);
        TicTacToe<Player,Player> game = new TicTacToe<Player,Player>(expert,p1);
        game.play();
    }
}
